from lilacs.brain.emotions.deepmoji import get_emotions, get_emojis
from lilacs.reasoning.sentiment_analysis import get_sentiment
from lilacs.reasoning.nlp.politness import get_politness


class LILACSEmotionalReactor:
