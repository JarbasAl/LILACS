...
from lilacs.brain.emotions.plutchik import Emotion, Neutrality
import random
import numpy as np
...
def _get_feeling_emotions():
    bucket = {}
    from lilacs.brain.emotions.emotions import EMOTIONS
...
def _get_feelings():
    ...
    for feeling in FEELINGS_TO_EMOTION_MAP:
        ...
        for emotion in FEELINGS_TO_EMOTION_MAP[feeling]:
            ...
            from lilacs.brain.emotions.plutchik import DIMENSIONS
