from lilacs.brain.emotions.reference_maps import EMOTION_CONTRASTS
import numpy as np
...
class Emotion(object):
    ...
    def triggered_reactions(self):
        from lilacs.brain.emotions import REACTION_TO_EMOTION_MAP, REACTIONS
        reactions = []
    ...
    def string_to_emotion(string=""):
        from lilacs.brain.emotions import EMOTIONS
        from lilacs.brain.emotions import FEELINGS
    ...
    def __add__(self, other):
        ...
        # create feeling
        from lilacs.brain.emotions import Feeling
    ...
    def __mul__(self, other):
        ...
        if isinstance(other, Emotion):
            from lilacs.brain.emotions import CompositeEmotion
...
class EmotionalDimension(object):
    ...
    def __add__(self, other):
        from lilacs.brain.emotions import CompositeDimension
