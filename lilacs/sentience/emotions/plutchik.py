...
class Emotion(object):
    ...
    def triggered_reactions(self):
        from lilacs.sentience.emotions import REACTION_TO_EMOTION_MAP, REACTIONS
        reactions = []
    ...
    def __mul__(self, other):
        ...
        if isinstance(other, Emotion):
            from lilacs.sentience.emotions import CompositeEmotion
...
class EmotionalDimension(object):
    ...
    def __add__(self, other):
        from lilacs.sentience.emotions import CompositeDimension
