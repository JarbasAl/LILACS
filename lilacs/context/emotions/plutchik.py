from lilacs.context.emotions.reference_maps import EMOTION_CONTRASTS
import numpy as np
...
class Emotion(object):
    ...
    def triggered_reactions(self):
        from lilacs.context.emotions.behaviour import REACTION_TO_EMOTION_MAP, REACTIONS
        reactions = []
    ...
    def string_to_emotion(string=""):
        ...
        from lilacs.context.emotions.feelings import FEELINGS
    ...
    def __add__(self, other):
        ...
        # create feeling
        from lilacs.context.emotions.feelings import Feeling
    ...
    def __mul__(self, other):
        ...
        if isinstance(other, Emotion):
            from lilacs.context.emotions.composite_emotions import CompositeEmotion
...
class EmotionalDimension(object):
    ...
    def __add__(self, other):
        from lilacs.context.emotions.composite_emotions import CompositeDimension
