from lilacs.context.emotions.plutchik import Emotion, EmotionalDimension, DIMENSIONS, Neutrality
...
class CompositeEmotion(Emotion):
    ...
    def equivalent_feeling(self):
        from lilacs.context.emotions.feelings import Feeling, FEELINGS_TO_EMOTION_MAP, FEELINGS
        if len(self.components) == 2:
