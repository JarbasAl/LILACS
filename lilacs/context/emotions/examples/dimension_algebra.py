from lilacs.context.emotions.emotions import EMOTIONS, DIMENSIONS
from lilacs.context.emotions.plutchik import EmotionalDimension, Neutrality
from lilacs.context.emotions.composite_emotions import COMPOSITE_EMOTIONS, CompositeEmotion, CompositeDimension
