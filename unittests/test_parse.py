...
from lilacs.util.parse import extract_datetime, extract_number, is_numeric, \
    is_fractional, extract_numbers
from lilacs.util.format import normalize
...
class TestNormalize(unittest.TestCase):
    ...
    def test_singular(self):
        self.assertEqual(normalize("i love dogs"), "i love dogs")
        self.assertEqual(normalize("i love dogs", make_singular=True),
                         "i love dog")
    ...
    def test_coref(self):
        ...
        text = "London is the capital and most populous city of England and " \
               ...
               "major settlement for two millennia. It was founded by the " \
               "Romans, who named it Londinium."
        solved = "London is capital and most populous city of England and United Kingdom. " \
    ...
    def test_extract_number(self):
        ...
        # self.assertEqual(extract_number("six trillion"), 600000000000.0)
    ...
    def test_extractdatetime(self):
        ...
        testExtract("Set timer for 2 minutes",
                    "2017-06-27 13:06:00", "set timer")
        testExtract("Set timer for two minutes",
                    "2017-06-27 13:06:00", "set timer")
    ...
    def test_numbers(self):
        ...
        self.assertEqual(normalize("that's one hundred"),
                         "that is 100")
        self.assertEqual(normalize("that's two one hundred"),
                         "that is 2 100")
